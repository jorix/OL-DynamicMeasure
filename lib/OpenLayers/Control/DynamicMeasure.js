...
OpenLayers.Control.DynamicMeasure = OpenLayers.Class(
     ...
     *     and labels text, can use keys: "Point", "Line",
     ...
     * {Object} Alterations of the default position of the labels, can use keys:
     *     "labelSegments" & "labelHeading", with values "start" "middle" and
     *     "end" refered of the current segment; and keys: "labelLength" &
     ...
     * styles - {Object} Alterations of the default styles of the points lines poligons and labels text, can use keys: "Point",
    ...
    showLabel: function(
        ...
        var featureLabel;
        if (layer.features.length < labelsNumber) {
        // add a label
            if (measure[0] === 0) {
                return false;
            }
